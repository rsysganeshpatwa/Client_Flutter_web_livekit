...
class _ConnectPageState extends State<ConnectPage> {
  ...
  final _welcomeMessageCtrl =
      TextEditingController(text: 'Weekly Roundtable Leadership Call');
  ...
  Future<void> _connect(BuildContext ctx) async {
    try {
      ...
      if (identity.isEmpty) {
        await ctx.showErrorDialog('Please enter your name',
            title: 'Input Error');
        setState(() {
          _busy = false;
        });
        ...
        await ctx.showErrorDialog('Please enter a room name',
            title: 'Input Error');
        setState(() {
          _busy = false;
        });
      ...
      final token = await _apiService.getToken(
          identity, roomName, _role.toString(), adminWelcomeMessage);
      ...
      await Navigator.pushAndRemoveUntil<void>(
        ...
        MaterialPageRoute(
          builder: (_) => PreJoinPage(
            args: JoinArgs(
              url: AppConfig
                  .apiLiveKitHttpsUrl, //dotenv.env['API_LIVEKIT_HTTPS_URL'] ?? '',
              token: token,
              simulcast: true,
              adaptiveStream: true,
              dynacast: true,
        ...
        child: isMobile
            ? Column(
                ...
                children: [
                  ...
                  Container(
                    width: screenWidth *
                        0.9, // Make the container take up 90% of the width for mobile
                    height: screenHeight *
                        0.3, // Adjust height based on screen height
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 39, 38,
                          104), // Background color of the vertical box
                      borderRadius:
                          BorderRadius.circular(10), // Rounded corners
                    ),
                    padding:
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(
                          ...
                          height: screenHeight *
                              0.06, // Adjust height relative to screen height for mobile
                        ),
                        SizedBox(
                            height: screenHeight *
                                0.05), // Spacer between logo and text for mobile
                        // Heading
                        Align(
                  ...
                  SizedBox(
                      height: screenHeight *
                          0.05), // Space between boxes for mobile
                  // New vertical box for login form (right panel for mobile)
                  Container(
                    width: screenWidth *
                        0.9, // Make the form take up 90% of the width for mobile
                      ...
                      children: [
                        ...
                        if (_isRoomNameInUrl) ...[
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: screenHeight *
                                  0.035, // Dynamic font size for mobile
                              fontWeight: FontWeight.bold,
                              color: const Color.fromARGB(
                                  255, 39, 38, 104), // Blue text color
                            ),
                          ),
                        ],
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          padding: EdgeInsets.symmetric(
              ...
              horizontal: screenHeight * 0.03), // Dynamic padding
          minimumSize: Size(80, screenHeight * 0.05), // Dynamic size
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(
                30.0), // Set corner radius for more rounded corners
          ),
        ),
        child: Row(
          mainAxisSize:
              MainAxisSize.min, // Make the button's width wrap its content
          children: [
            Text(
              'Connect',
              style: TextStyle(
            ...
            SizedBox(
                width: screenHeight * 0.01), // Spacing between text and arrow
            Icon(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(
                  color: const Color.fromARGB(
                      255, 39, 38, 104), // Focused border color
                  width: 2.0,
                ),
              ),
              contentPadding:
  ...
  Widget buildRoleSelection() {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
            height: screenHeight *
                0.02), // Add spacing between role selection and room name field
        ...
        if (_selectedRole == Role.admin) ...[
          SizedBox(
              height:
                  screenHeight * 0.02), // Spacing before Welcome Message field
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(
