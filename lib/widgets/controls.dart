...
// Implement debounced video disable
 ...
 // Implement debounced video enable
  ...
  void _enableScreenShare() async {
    int screenShareCount = widget.room.remoteParticipants.values
        .where((element) => element.isScreenShareEnabled())
        .length;
    if (screenShareCount < 2) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text("Screen Share Limit Reached"),
            content: Text(
  ...
  void _disableScreenShare() async {
    ...
    print('stopped screen share');
    // check if camera is enabled
    print("camera enabled: ${participant.isCameraEnabled()}");
    print("screen share enabled: ${participant.isScreenShareEnabled()}");
  ...
  Widget build(BuildContext context) {
    bool isMobile = MediaQuery.of(context).size.width <
        600; // Example breakpoint for mobile
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Tooltip(
            message: 'Disconnect',
            child: _buildControlButton(Icons.call_end, Colors.deepOrange,
                _onTapDisconnect, Colors.white,
                isMobile: isMobile),
          ),
          ...
          Expanded(
            child: Align(
              ...
              child: Wrap(
                ...
                alignment:
                    WrapAlignment.center, // Center buttons within this area
                children: [
  ...
  Widget _buildControlButton(
      IconData iconImage, Color color, VoidCallback onPressed, Color iconColor,
      {bool isMobile = false}) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        padding: const EdgeInsets.all(8),
        minimumSize: isMobile ? const Size(40, 40) : const Size(50, 50),
      ),
      onPressed: onPressed,
      child: Icon(
        iconImage,
